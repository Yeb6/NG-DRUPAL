...
if($first_segment == 'wmr-usapc' || $host=='wmr-usapc') {
     $sites[$host] = 'wmr_usapc';
 }
 elseif($first_segment == 'wmr-usavan' || $host=='wmr-usavan') {
     $sites[$host] = 'wmr_usavan';
 }
elseif ($first_segment == 'msmr' || $host=='msmr') {
    $sites[$host] = 'msmr_hq';
}
elseif ($first_segment == 'msmr-polen' || $host=='msmr-polen') {
    $sites[$host] = 'msmr_polen';
} 
elseif ($first_segment == 'msmr-malta' || $host=='msmr-malta') {
    $sites[$host] = 'msmr_malta';
} 
else {
    $sites[$host] = 'default';
}
